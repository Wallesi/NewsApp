...
const Economics=()=>{
    ...
    useEffect(() => {
        ...
        fetch("https://newsapi.org/v2/everything?q=economy+argentina&pageSize=15&apiKey=a3aeae7b68034752a63e1703ded74468")
    ...
    return (
      ...
      <h1 className="text-3xl font-semibold mb-4">Economics</h1>
